...
QT_MOC_LITERAL(13, 21) // "on_pushButton_clicked"
    ...
    "signin\0back\0\0on_pushButton_clicked"
};
...
void signin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&signin::back)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<signin, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QString, std::false_type>
