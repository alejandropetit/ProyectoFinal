...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_registro_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_registro_t qt_meta_stringdata_registro = {
    {
QT_MOC_LITERAL(0, 8), // "registro"
QT_MOC_LITERAL(9, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(31, 0) // ""

    },
    "registro\0on_pushButton_clicked\0"
};
...
const QMetaObject registro::staticMetaObject = { {
    ...
    qt_meta_stringdata_registro.offsetsAndSize,
    qt_meta_data_registro,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_registro_t
, QtPrivate::TypeAndForceComplete<registro, std::true_type>
