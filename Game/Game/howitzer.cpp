...
howitzer::howitzer(int px, int py,double tilt, bool spin, unsigned char efficiency)
{
    tilt = -tilt;
...
void howitzer::Actualizar(int px, int py, double tilt, bool spin, unsigned char efficiency)
{
